...
NS_LOG_COMPONENT_DEFINE ("promet");
...
RoutingExperiment::Run (int argc, char **argv)
{
  ...
  if (m_csvFileNamePrefix == "Net")
    {
	    m_csvFileNamePrefix = "Sc" + std::to_string (scenario) 
  ...
  case 1:
  {
	  ...
	  //	  pauseProb=0.0
	  //	  maxPause=0.0
    std::string traceFile = "scratch/scenario1_300.ns_movements";
  ...
  m_csvFileNamePrefix += "-" + protocolName; 
